...
class DescriptionActivity : AppCompatActivity() {
    ...
    private val pokeType1: TextView get() = findViewById(R.id.textView_type1_pokemon)
    ...
    private fun substitute() {
        ...
        viewModel.test(api.typeList)
        viewModel.pokemonLiveData1.observe(this) {
            pokeType1.text = api.typeList[0].type.name
            pokeType2.visibility = View.GONE
            pokeType3.visibility = View.GONE
        }
